...
if __name__ == '__main__':
    ...
    root = bg.SimpleDirDialog(prompt='Choose AV45 data dir',
                              indir = '/home/jagust')
    ...
    # text dialog to get normed AV45 file and coreg directory
    norm_av45_glob = bg.TextEntry()
    logging.info(norm_av45_glob)
    ...
    for sub in subs:
        ...
        # get ref -region normed av45 volume
        globstr = os.path.join(pth, norm_av45_glob)
        ...
        globstr = os.path.join(pth, coregdir_glob, 'rB*aparc_aseg.nii*')
        raparc = utils.find_single_file(globstr)
        if raparc is None:
